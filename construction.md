...
**The record also answers the witnessed index of an exact commitment
sequence.** Several strictly increasing sequences may be witnessed at one
index; each one the venue kept is held, not a hole merely because the latest
answer at that index names the highest. Without the exact read, a witnessed
commitment can be misread as one the record moved past, turning a final receipt
into an excused one.
