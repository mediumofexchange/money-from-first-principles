...
| `pool-v3.md` | **successor layouts, incomplete construction** | Six relations, public-input orders and canonical statement/publication records. Configuration, artifact pins and adoption remain unset; no backing may yet declare v3. |
