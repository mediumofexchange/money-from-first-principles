...
| `pool-v3.md` | **successor layouts, incomplete construction** | Six relations, canonical statement/publication records, history/evidence chains, snapshots, receipts and segment headers. Configuration, artifact pins and adoption remain unset; no backing may yet declare v3. |
