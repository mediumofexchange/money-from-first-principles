...
| `pool-v3.md` | **successor layouts, incomplete construction** | Six relations, canonical statement/publication records, history/evidence chains, snapshots and receipts. Configuration, artifact pins and adoption remain unset; no backing may yet declare v3. |
