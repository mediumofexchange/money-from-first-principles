...
| `pool-v3.md` | **successor layouts, incomplete construction** | Six relations, record/evidence frames, configuration framing and signed constant-root terms. Approved artifact pins and adoption remain unset; no backing may yet declare v3. |
